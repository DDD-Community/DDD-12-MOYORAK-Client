						...
						<div className="flex flex-col gap-3.75 relative">
							...
							<div className="flex gap-2 flex-wrap">
								...
								{images.map((img, idx) => (
									<div
										key={idx}
										className="w-[80px] h-[80px] rounded-[12px] border border-gray-05 relative flex-shrink-0 overflow-hidden flex items-center justify-center"
									>
